...
# Исходные пословицы и варианты для замены
proverbs = [
...
variants = [
    'кот', 'шеф', 'мозг', 'лес', 'фолк', 
    'код', 'рот', 'мёд', 'лук', 'год', 
    'час', 'друг', 'муж', 'айфон', 'стол', 
    'нос', 'сыр', 'хлеб', 'мир', 'свет', 
    'рок', 'дед', 'дом', 'сон', 'глаз'
]
# Запрос у пользователя количества пословиц
count = int(input("Сколько пословиц вы хотите получить? "))
count = min(count, len(proverbs), len(variants)) # Ограничиваем количество до доступных элементов
...
for _ in range(count):
    ...
    # Замена слова "ум" на вариант (игнорируя регистр)
    new_proverb = re.sub(r'\bум\b', variant, proverb, flags=re.IGNORECASE)
